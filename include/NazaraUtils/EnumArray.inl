...
namespace Nz
{
	...
	template<typename E, typename V>
	constexpr EnumArray<E, V>::kv_iterator::kv_iterator(kv_iter_tag arrayTag, typename EnumArray::difference_type index) :
	...
	template<typename E, typename V>
	constexpr auto EnumArray<E, V>::kv_iterator::operator++(int) noexcept -> kv_iterator
	{
		kv_iterator it(*this);
		++m_index;
	...
	template<typename E, typename V>
	constexpr auto EnumArray<E, V>::kv_iterator::operator++() noexcept -> kv_iterator&
	{
		++m_index;
		return *this;
	}
	...
	template<typename E, typename V>
	constexpr auto EnumArray<E, V>::kv_iterator::operator+(typename EnumArray::difference_type n) noexcept -> kv_iterator
	{
	...
	template<typename E, typename V>
	constexpr auto EnumArray<E, V>::kv_iterator::operator*() const noexcept -> value_type
	{
	...
	template<typename E, typename V>
	constexpr auto EnumArray<E, V>::kv_iterator::operator[](typename EnumArray::difference_type n) noexcept -> value_type
	{
