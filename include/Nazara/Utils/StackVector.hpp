...
#ifndef NAZARA_UTILS_STACKVECTOR_HPP
#define NAZARA_UTILS_STACKVECTOR_HPP
...
#else
	#define NazaraStackVector(T, capacity) Nz::StackVector<T>(static_cast<T*>(operator new((capacity) * sizeof(T))), capacity)
#endif
...
#include <Nazara/Utils/StackVector.inl>

#endif // NAZARA_UTILS_STACKVECTOR_HPP
